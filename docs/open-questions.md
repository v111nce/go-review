...
| --- | --- | --- | --- | --- |
| PO-1 | Product | 第一版常用 adapter 是否按 `cmd`、`go.format`、`go.lint`、`go.arch`、`go.security`、`go.test`、`go.semantic`、`report.github` 交付？ | 已决定：第一版按这组常用 adapter 交付；`go.lint`/format 优先复用 `golangci-lint`，`go.semantic` 长期基于 `go/analysis` analyzer，`go.test` 独立保留 | closed |
